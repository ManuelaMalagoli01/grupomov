...
const SAS_VENDAS_MODELOS = {
  ...
  "Empilhadeiras Patoladas (Stackers Elétricos)": ["EPW","EPB EDGE","EPL16/20"],
  "Empilhadeiras Semielétricas": ["S.SPM","EHM0415","EHM1516","SEPS","EHM1025"],
  "Transpaleteiras Elétricas": ["TEL22","TEE15 EDGE","TEE20 EDGE","TEN22","TER28"],
  "Transpaleteiras Manuais": ["SAC25","SAC30","SAC30 com Freio","SAC LOW","SAC.E","SAC.S","SAC.Z30","SAC.ZS30","S.DGB","S.HLT"],
  "Selecionadora de Pedidos (Order Picker)": ["SPTE30"],
...
const FERIAS_SEED = [
  ...
  {nome:"BRUNO ALEXANDRE FONTES",          admissao:"1998-11-20", depAtual:"MANUTENÇÃO B", setor:"Centro-Oeste - Gustavo", aquisitivoIni:"2024-11-20", aquisitivoFim:"2025-11-19", limite:"2026-10-19", saldoDias:"12", previsaoIni:"2026-07-01", previsaoFim:"2026-07-12"},
  {nome:"DAVI ALVES DA CRUZ",              admissao:"2024-04-08", depAtual:"MANUTENÇÃO B", setor:"Oficina Interna - Hebert", aquisitivoIni:"2025-04-04", aquisitivoFim:"2026-04-07", limite:"2027-03-07", saldoDias:"12", previsaoIni:"2026-09-01", previsaoFim:"2026-09-12"},
  {nome:"DENISON RODRIGUES SANTOS",        admissao:"2014-09-01", depAtual:"MANUTENÇÃO B", setor:"Oficina Externa - Gustavo", aquisitivoIni:"2025-09-01", aquisitivoFim:"2026-08-31", limite:"2027-07-31", saldoDias:"30", previsaoIni:"2026-11-03", previsaoFim:"2026-12-03"},
  {nome:"DILSON DA SILVA SANTOS",          admissao:"2014-05-15", depAtual:"MANUTENÇÃO A", setor:"Oficina Externa - Gustavo", aquisitivoIni:"2025-05-15", aquisitivoFim:"2026-05-14", limite:"2027-04-13", saldoDias:"12", previsaoIni:"2026-07-20", previsaoFim:"2026-07-31"},
  {nome:"EDUARDO FERNANDES DE OLIVEIRA",   admissao:"2006-06-19", depAtual:"MANUTENÇÃO B", setor:"Oficina Interna - Hebert", aquisitivoIni:"2025-06-18", aquisitivoFim:"2026-06-18", limite:"2027-05-18", saldoDias:"12", previsaoIni:"2026-10-13", previsaoFim:"2026-10-24"},
  {nome:"HEBERT ANTONIO DOS SANTOS RIBEIRO", admissao:"2012-05-02", depAtual:"MANUTENÇÃO B", setor:"Oficina Interna - Hebert", aquisitivoIni:"2025-05-02", aquisitivoFim:"2026-05-01", limite:"2027-03-31", saldoDias:"12", previsaoIni:"2026-09-10", previsaoFim:"2026-09-21"},
  {nome:"JOAO BATISTA DA SILVA",           admissao:"2020-10-01", depAtual:"MANUTENÇÃO B", setor:"Oficina Interna - Hebert", aquisitivoIni:"2025-10-01", aquisitivoFim:"2026-09-30", limite:"2027-08-30", saldoDias:"12", previsaoIni:"2026-11-19", previsaoFim:"2026-11-30"},
  {nome:"JUNIO FERREIRA DA SILVA",         admissao:"2021-04-12", depAtual:"MANUTENÇÃO B", setor:"Oficina Interna - Hebert", aquisitivoIni:"2025-04-12", aquisitivoFim:"2026-04-11", limite:"2027-03-11", saldoDias:"12", previsaoIni:"2026-09-19", previsaoFim:"2026-09-29"},
...
const LOGO_MOV_SMALL = "data:image/png;base64,";
const TEMPLATE_COMISSAO_SAS_B64 = "";
...
const TC = {
  ...
  "Luiz G. Pinheiro":"#C62828","Matheus Felipe":"#00838F","Pedro Pimentel":"#AD1457","Helbert Junior":"#FF4081",
...
const gerarPlanilhaComissaoSas = async (registros, mes, ano, nomeRepresentante)=>{
  ...
  // Baixa o modelo oficial (base64 embutido) e carrega preservando toda a formatacao
  const b64 = TEMPLATE_COMISSAO_SAS_B64;
  ...
  ws.getCell("B2").value = `${nomeRepresentante||""} - ${mes}/${ano}`;

  const preencherSecao = (registros, startRow, maxRows, dataField)=>{
    let excedente = 0;
    registros.forEach((s,i)=>{
      if(i>=maxRows){excedente++; return;}
      const r = startRow + i;
      ws.getCell(`B${r}`).value = s.cliente||s.nome||"";
      ws.getCell(`C${r}`).value = fmtDataBR(s[dataField])||"";
      ws.getCell(`D${r}`).value = s.nfNum||"";
      ws.getCell(`E${r}`).value = s.equipamento||"";
      ws.getCell(`F${r}`).value = 1;
      ws.getCell(`G${r}`).value = parseVal(s.valor);
      ws.getCell(`I${r}`).value = 0.01;
      // H e J ja tem formula no modelo (=G*F e =H*I) — nao mexe nelas
    });
    return excedente;
  };
  const excV = preencherSecao(secaoVenda, 5, 9, "envioFaturamento");
  const excE = preencherSecao(secaoEntrega, 17, 6, "dataRealizacao");
  const excG = preencherSecao(secaoGarantia, 26, 5, "dataGarantia");

  const buf = await workbook.xlsx.writeBuffer();
  const blob = new Blob([buf], {type:"application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"});
  const url = URL.createObjectURL(blob);
  const a = document.createElement("a");
  a.href=url; a.download=`Comissao_SAS_${mes}-${ano}.xlsx`; a.click();
...
// Gera o PDF da Proposta SAS Vendas com as duas logos (Grupo MOV + SAS/Noblelift), data de geracao e responsavel
const gerarPDFPropostaSasVend = async (p, autor)=>{
  try{
    ...
    campo("CNPJ", p.cnpj);
    (p.contatos||[]).forEach((c,i)=>campo(`Contato ${i+1}`, [c.nome,c.tel,c.email].filter(Boolean).join(" · ")));
    ...
    const anexosList=[["Cert. Entrega Técnica",p.anexos?.certEntregaTecnica],["Cert. Bateria Chumbo",p.anexos?.certBateriaChumbo],["Cert. Bateria Lítio",p.anexos?.certBateriaLitio],["Cert. Carregador Lítio",p.anexos?.certCarregadorLitio],["Relatório Entrega MOV",p.anexos?.relatorioEntregaTecnicaMov],["Nota Fiscal",p.notaFiscalAnexo]];
...
// Slot de anexo PDF reutilizavel: envia pro Supabase Storage, mostra link + nome do arquivo salvo
const AnexoPDF=({label, value, onChange, pastaId, campo})=>{
  const [loading,setLoading]=useState(false);
  return(
    <div style={{display:"flex",flexDirection:"column",gap:4}}>
      <label style={{fontSize:9,fontWeight:700,color:"#94A3B8",textTransform:"uppercase"}}>{label}</label>
      {value?.url?(
        <div style={{display:"flex",alignItems:"center",gap:8,padding:"7px 10px",background:"#F0FFF5",border:"1px solid #BBF7D0",borderRadius:8}}>
          <a href={value.url} target="_blank" rel="noreferrer" style={{fontSize:11,color:"#14532D",fontWeight:600,flex:1,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>📎 {value.nome||"Ver arquivo"}</a>
          <button onClick={()=>onChange(null)} title="Remover" style={{background:"none",border:"none",color:"#DC2626",cursor:"pointer",fontSize:13,fontWeight:700}}>✕</button>
        </div>
      ):(
        <label style={{display:"flex",alignItems:"center",justifyContent:"center",gap:6,padding:"8px 10px",background:loading?"#F1F5F9":"#F8FAFC",border:"1.5px dashed #CBD5E1",borderRadius:8,cursor:loading?"wait":"pointer",fontSize:11,color:"#64748B",fontWeight:600}}>
          {loading?"Enviando...":"📎 Anexar PDF"}
          <input type="file" accept=".pdf" style={{display:"none"}} disabled={loading} onChange={async e=>{
            const file=e.target.files[0]; if(!file)return;
            setLoading(true);
            try{ const up=await uploadArquivoSupabase(file,pastaId,campo); onChange(up); }
...
function AppSidebar({tab, setTab, user, empAlerta, badges={}, collapsed=false, setCollapsed=()=>{}}){
  ...
  const ToggleBtn = (
    <button onClick={()=>setCollapsed(p=>!p)} title={collapsed?"Expandir menu":"Recolher menu"} style={{position:"fixed",left:W-13,top:66,width:26,height:26,borderRadius:"50%",border:"2px solid #FFF",background:"#F5C200",color:"#1A1A1A",fontSize:11,fontWeight:900,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",boxShadow:"0 2px 6px rgba(0,0,0,.2)",zIndex:60,transition:"left .18s ease",fontFamily:"inherit"}}>{collapsed?"›":"‹"}</button>
  );
...
export default function App(){
  ...
  const [showArqFerias,setShowArqFerias]=useState(false);
  ...
  useEffect(()=>{
    const load = async () => {
      ...
      if(feriasRows.length>0){ setFerias(feriasRows); }
        ...
        const seed=FERIAS_SEED.map((f,i)=>({...f,id:`FER${i+1}_${Date.now()}`,ano:"2026",arquivado:false,registradoEm:new Date().toISOString()}));
        setFerias(seed);
        db.saveBatch("ferias_colaboradores",seed);
      }
  ...
  // ── SINCRONIZAÇÃO EM TEMPO REAL (Supabase Realtime via WebSocket) ──
  // Qualquer insert/update/delete feito por qualquer usuário aparece na hora, sem precisar recarregar.
  useEffect(()=>{
    const setters={
    ...
    const applyChange=(table,eventType,rec,oldRec)=>{
      ...
      setter(prev=>{
        ...
        const novo={...(row||{}),id};
        return exists?arr.map(x=>x.id===id?novo:x):[novo,...arr];
      });
    };
    let ws, hbTimer, reconnectTimer, alive=true, ref=1;
    const connect=()=>{
      try{
        ws=new WebSocket(`${SUPA_URL.replace("https://","wss://")}/realtime/v1/websocket?apikey=${SUPA_KEY}&vsn=1.0.0`);
      }catch(e){ return; }
      ws.onopen=()=>{
        ws.send(JSON.stringify({topic:"realtime:public",event:"phx_join",payload:{config:{postgres_changes:[{event:"*",schema:"public"}]}},ref:String(ref++)}));
        hbTimer=setInterval(()=>{ if(ws&&ws.readyState===1) ws.send(JSON.stringify({topic:"phoenix",event:"heartbeat",payload:{},ref:String(ref++)})); },25000);
      };
      ws.onmessage=(msg)=>{
        try{
          ...
          if(m.event==="postgres_changes"&&m.payload&&m.payload.data){
            ...
            applyChange(d.table, d.type, d.record, d.old_record);
          }
        }catch(e){}
      };
      ws.onclose=()=>{ clearInterval(hbTimer); if(alive){ reconnectTimer=setTimeout(connect,4000); } };
      ws.onerror=()=>{ try{ws.close();}catch(e){} };
    };
    connect();
    return ()=>{ alive=false; clearInterval(hbTimer); clearTimeout(reconnectTimer); try{ws&&ws.close();}catch(e){} };
  },[]);
          ...
          <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.5)",zIndex:1000,display:"flex",alignItems:"center",justifyContent:"center",padding:16}} onClick={e=>{if(e.target===e.currentTarget){setSasVendModal(false);setSasVendEdit(null);}}}>
            <div style={{background:"#FFF",borderRadius:16,width:"100%",maxWidth:820,maxHeight:"92vh",overflowY:"auto",boxShadow:"0 24px 80px rgba(0,0,0,.3)"}}>
              <div style={{background:"#1A1A1A",padding:"16px 22px",display:"flex",justifyContent:"space-between",alignItems:"center",position:"sticky",top:0,zIndex:2}}>
                ...
                <button onClick={()=>{setSasVendModal(false);setSasVendEdit(null);}} style={{background:"rgba(255,255,255,.1)",border:"none",borderRadius:8,color:"#FFF",fontSize:20,cursor:"pointer",width:32,height:32}}>✕</button>
              </div>
              <div style={{padding:22,display:"flex",flexDirection:"column",gap:18}}>

                {/* Identificação */}
                <div>
                  <div style={{fontSize:11,fontWeight:700,color:"#94A3B8",textTransform:"uppercase",letterSpacing:.6,marginBottom:10}}>📋 Identificação</div>
                  <div style={{display:"grid",gridTemplateColumns:"1fr 2fr 1fr",gap:12}}>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Nº Proposta</label><input type="text" value={sasVendEdit?.numero||"(gerado ao salvar)"} disabled style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#F1F5F9",color:"#64748B",fontWeight:700}}/></div>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Cliente</label><input type="text" value={sasVendEdit?.cliente||""} onChange={e=>setSasVendEdit(p=>({...p,cliente:e.target.value}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/></div>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>CNPJ</label><input type="text" value={sasVendEdit?.cnpj||""} onChange={e=>setSasVendEdit(p=>({...p,cnpj:e.target.value}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/></div>
                  </div>
                </div>
                ...
                <div>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                    <div style={{fontSize:11,fontWeight:700,color:"#94A3B8",textTransform:"uppercase",letterSpacing:.6}}>👤 Contatos (até 5)</div>
                    {(sasVendEdit?.contatos||[]).length<5&&<button onClick={()=>setSasVendEdit(p=>({...p,contatos:[...(p.contatos||[]),{nome:"",tel:"",email:""}]}))} style={{background:"#1565C0",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"4px 10px",fontSize:11,fontWeight:600}}>+ Adicionar Contato</button>}
                  </div>
                  <div style={{display:"flex",flexDirection:"column",gap:8}}>
                    {(sasVendEdit?.contatos||[{nome:"",tel:"",email:""}]).map((c,ci)=>(
                      <div key={ci} style={{display:"grid",gridTemplateColumns:"1.2fr 1fr 1.2fr auto",gap:8,alignItems:"center"}}>
                        <input type="text" placeholder="Nome" value={c.nome||""} onChange={e=>{const arr=[...(sasVendEdit?.contatos||[{nome:"",tel:"",email:""}])];arr[ci]={...arr[ci],nome:e.target.value};setSasVendEdit(p=>({...p,contatos:arr}));}} style={{fontSize:12,padding:"7px 10px",borderRadius:8,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/>
                        <input type="text" placeholder="Telefone" value={c.tel||""} onChange={e=>{const arr=[...(sasVendEdit?.contatos||[{nome:"",tel:"",email:""}])];arr[ci]={...arr[ci],tel:e.target.value};setSasVendEdit(p=>({...p,contatos:arr}));}} style={{fontSize:12,padding:"7px 10px",borderRadius:8,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/>
                        <input type="email" placeholder="Email" value={c.email||""} onChange={e=>{const arr=[...(sasVendEdit?.contatos||[{nome:"",tel:"",email:""}])];arr[ci]={...arr[ci],email:e.target.value};setSasVendEdit(p=>({...p,contatos:arr}));}} style={{fontSize:12,padding:"7px 10px",borderRadius:8,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/>
                        {(sasVendEdit?.contatos||[]).length>1&&<button onClick={()=>{const arr=(sasVendEdit?.contatos||[]).filter((_,j)=>j!==ci);setSasVendEdit(p=>({...p,contatos:arr}));}} style={{background:"#DC2626",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"5px 8px",fontSize:10}}>✕</button>}
                      </div>
                    ))}
                  </div>
                </div>
                ...
                {/* Equipamento */}
                <div>
                  <div style={{fontSize:11,fontWeight:700,color:"#94A3B8",textTransform:"uppercase",letterSpacing:.6,marginBottom:10}}>🏗️ Equipamento</div>
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:10}}>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}>
                      <label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Modelo SAS</label>
                      <select value={sasVendEdit?.modeloSAS||""} onChange={e=>setSasVendEdit(p=>({...p,modeloSAS:e.target.value}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}>
                        <option value="">Selecione...</option>
                        {Object.entries(SAS_VENDAS_MODELOS).map(([cat,models])=>(
                          <optgroup key={cat} label={cat}>{models.map(m=><option key={m} value={m}>{m}</option>)}</optgroup>
                        ))}
                      </select>
                    </div>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}>
                      <label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Bateria</label>
                      <div style={{display:"flex",gap:14,padding:"9px 0"}}>
                        <label style={{display:"flex",alignItems:"center",gap:5,fontSize:13,cursor:"pointer"}}><input type="radio" checked={(sasVendEdit?.bateria||"chumbo")==="chumbo"} onChange={()=>setSasVendEdit(p=>({...p,bateria:"chumbo"}))}/> Chumbo</label>
                        <label style={{display:"flex",alignItems:"center",gap:5,fontSize:13,cursor:"pointer"}}><input type="radio" checked={sasVendEdit?.bateria==="litio"} onChange={()=>setSasVendEdit(p=>({...p,bateria:"litio"}))}/> Lítio</label>
                      </div>
                    </div>
                  </div>
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:10}}>
                  ...
                  {(sasVendEdit?.bateria||"chumbo")==="chumbo"&&(
                    <div style={{background:"#F8FAFC",border:"1px solid #EEF1F4",borderRadius:10,padding:12}}>
                      <div style={{fontSize:10,fontWeight:700,color:"#64748B",textTransform:"uppercase",marginBottom:8}}>Acessórios (bateria chumbo)</div>
                      <div style={{display:"flex",gap:16,marginBottom:8}}>
                        <label style={{display:"flex",alignItems:"center",gap:5,fontSize:12,cursor:"pointer"}}><input type="checkbox" checked={!!sasVendEdit?.acessorios?.estrado} onChange={e=>setSasVendEdit(p=>({...p,acessorios:{...(p.acessorios||{}),estrado:e.target.checked}}))}/> Estrado</label>
                        <label style={{display:"flex",alignItems:"center",gap:5,fontSize:12,cursor:"pointer"}}><input type="checkbox" checked={!!sasVendEdit?.acessorios?.suporte} onChange={e=>setSasVendEdit(p=>({...p,acessorios:{...(p.acessorios||{}),suporte:e.target.checked}}))}/> Suporte</label>
                      </div>
                      <input type="text" placeholder="Modelo do acessório..." value={sasVendEdit?.acessorios?.modelo||""} onChange={e=>setSasVendEdit(p=>({...p,acessorios:{...(p.acessorios||{}),modelo:e.target.value}}))} style={{width:"100%",fontSize:12,padding:"8px 10px",borderRadius:8,border:"1.5px solid #E0E0E0",background:"#FFF",boxSizing:"border-box"}}/>
                    </div>
                  )}
                </div>
                ...
                {/* Prazos */}
                <div>
                  <div style={{fontSize:11,fontWeight:700,color:"#94A3B8",textTransform:"uppercase",letterSpacing:.6,marginBottom:10}}>📅 Prazos e Nota Fiscal</div>
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:12,marginBottom:10}}>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Prazo Entrega Inicial</label><input type="date" value={sasVendEdit?.prazoEntregaInicial||""} onChange={e=>setSasVendEdit(p=>({...p,prazoEntregaInicial:e.target.value}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/></div>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}>
                      <label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Data Conf. Fábrica</label>
                      <input type="date" value={sasVendEdit?.dataConfFabrica||""} onChange={e=>setSasVendEdit(p=>({...p,dataConfFabrica:e.target.value}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/>
                      {sasVendEdit?.prazoEntregaInicial&&sasVendEdit?.dataConfFabrica&&(()=>{const d=Math.round((new Date(sasVendEdit.dataConfFabrica)-new Date(sasVendEdit.prazoEntregaInicial))/86400000);return<div style={{fontSize:10,fontWeight:700,color:d>0?"#C62828":"#1A7A3C",marginTop:2}}>SLA: {d>0?`+${d}`:d} dia(s)</div>;})()}
                    </div>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Previsão Chegada Cliente</label><input type="date" value={sasVendEdit?.previsaoChegadaCliente||""} onChange={e=>setSasVendEdit(p=>({...p,previsaoChegadaCliente:e.target.value}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/></div>
                  </div>
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Nº Nota Fiscal</label><input type="text" value={sasVendEdit?.notaFiscalNum||""} onChange={e=>setSasVendEdit(p=>({...p,notaFiscalNum:e.target.value}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/></div>
                    <AnexoPDF label="Anexo Nota Fiscal" value={sasVendEdit?.notaFiscalAnexo} onChange={v=>setSasVendEdit(p=>({...p,notaFiscalAnexo:v}))} pastaId={sasVendEdit?.id||"temp"} campo="nota_fiscal"/>
                  </div>
                </div>

                {/* Entrega Técnica */}
                <div>
                  <div style={{fontSize:11,fontWeight:700,color:"#94A3B8",textTransform:"uppercase",letterSpacing:.6,marginBottom:10}}>🔧 Entrega Técnica</div>
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:12}}>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Data</label><input type="date" value={sasVendEdit?.entregaTecnica?.data||""} onChange={e=>setSasVendEdit(p=>({...p,entregaTecnica:{...(p.entregaTecnica||{}),data:e.target.value}}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/></div>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Relatório</label><input type="text" value={sasVendEdit?.entregaTecnica?.relatorio||""} onChange={e=>setSasVendEdit(p=>({...p,entregaTecnica:{...(p.entregaTecnica||{}),relatorio:e.target.value}}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/></div>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Documentação SAS</label><input type="text" value={sasVendEdit?.entregaTecnica?.documentacaoSas||""} onChange={e=>setSasVendEdit(p=>({...p,entregaTecnica:{...(p.entregaTecnica||{}),documentacaoSas:e.target.value}}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}/></div>
                    <div style={{display:"flex",flexDirection:"column",gap:4}}>
                      <label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Status</label>
                      <select value={sasVendEdit?.entregaTecnica?.status||"pendente"} onChange={e=>setSasVendEdit(p=>({...p,entregaTecnica:{...(p.entregaTecnica||{}),status:e.target.value}}))} style={{fontSize:13,padding:"9px 12px",borderRadius:10,border:"1.5px solid #E0E0E0",background:"#FAFAFA"}}>
                        <option value="pendente">Pendente</option><option value="em_andamento">Em Andamento</option><option value="finalizado">Finalizado</option>
                      </select>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <div style={{fontSize:11,fontWeight:700,color:"#94A3B8",textTransform:"uppercase",letterSpacing:.6,marginBottom:10}}>📎 Documentação</div>
                  <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}>
                    <AnexoPDF label="Certificado de Entrega Técnica" value={sasVendEdit?.anexos?.certEntregaTecnica} onChange={v=>setSasVendEdit(p=>({...p,anexos:{...(p.anexos||{}),certEntregaTecnica:v}}))} pastaId={sasVendEdit?.id||"temp"} campo="cert_entrega_tecnica"/>
                    <AnexoPDF label="Certificado Entrega Bateria (Chumbo)" value={sasVendEdit?.anexos?.certBateriaChumbo} onChange={v=>setSasVendEdit(p=>({...p,anexos:{...(p.anexos||{}),certBateriaChumbo:v}}))} pastaId={sasVendEdit?.id||"temp"} campo="cert_bateria_chumbo"/>
                    <AnexoPDF label="Certificado Entrega Bateria (Lítio)" value={sasVendEdit?.anexos?.certBateriaLitio} onChange={v=>setSasVendEdit(p=>({...p,anexos:{...(p.anexos||{}),certBateriaLitio:v}}))} pastaId={sasVendEdit?.id||"temp"} campo="cert_bateria_litio"/>
                    <AnexoPDF label="Certificado Entrega Carregador (Lítio)" value={sasVendEdit?.anexos?.certCarregadorLitio} onChange={v=>setSasVendEdit(p=>({...p,anexos:{...(p.anexos||{}),certCarregadorLitio:v}}))} pastaId={sasVendEdit?.id||"temp"} campo="cert_carregador_litio"/>
                    <AnexoPDF label="Relatório Entrega Técnica MOV" value={sasVendEdit?.anexos?.relatorioEntregaTecnicaMov} onChange={v=>setSasVendEdit(p=>({...p,anexos:{...(p.anexos||{}),relatorioEntregaTecnicaMov:v}}))} pastaId={sasVendEdit?.id||"temp"} campo="relatorio_mov"/>
                  </div>
                </div>
                ...
                <div style={{display:"flex",justifyContent:"flex-end",gap:8,paddingTop:4,borderTop:"1px solid #F1F5F9"}}>
                  ...
                  <BtnY onClick={()=>{
                    const d=sasVendEdit;
                    if(!d?.cliente){alert("Informe o cliente.");return;}
                    if(d?.id){
                      updateSasVend(d.id,d);
                    }else{
                      const ano=new Date().getFullYear();
                      const seq=(sasVendas||[]).filter(x=>x&&x.numero&&x.numero.endsWith("/"+ano)).length+1;
                      const numero=`${String(seq).padStart(4,"0")}/${ano}`;
                      const row={...d,id:`SASV${Date.now()}_${Math.floor(Math.random()*9999)}`,numero,registradoPor:user.name,registradoEm:new Date().toISOString(),status:"aberta",arquivado:false};
                      setSasVendas(p=>[row,...p]);db.save("sas_vendas",row.id,row);
                    }
                    notify("✅ Proposta salva!");setSasVendModal(false);setSasVendEdit(null);
                  }}>Salvar</BtnY>
                </div>
              </div>
            </div>
    ...
    return (
      <>
        ...
        {tab==="mau_uso"&&(()=>{
          ...
          return(<div style={{animation:"fadeIn .3s ease"}}>
            ...
            {showFiltrosMU&&<div className="card" style={{padding:"8px 10px",marginBottom:16,display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
              <div style={{position:"relative",flex:1,minWidth:200}}><span style={{position:"absolute",left:10,top:"50%",transform:"translateY(-50%)",color:"#AAA",fontSize:11}}>🔍</span><input type="text" value={muSearch} onChange={e=>setMuSearch(e.target.value)} placeholder="Buscar empresa, PAT, relatório, chamado..." style={{width:"100%",padding:"7px 10px 7px 30px",fontSize:12,boxSizing:"border-box"}}/></div>
              <div style={{display:"flex",alignItems:"center",gap:4}}><span style={{fontSize:11,color:"#888",fontWeight:600}}>De</span><input type="date" value={muFrom} onChange={e=>setMuFrom(e.target.value)}/></div>
              <div style={{display:"flex",alignItems:"center",gap:4}}><span style={{fontSize:11,color:"#888",fontWeight:600}}>Até</span><input type="date" value={muTo} onChange={e=>setMuTo(e.target.value)}/></div>
                  ...
                  return(<div key={p.id} className="card" style={{padding:0,overflow:"hidden",opacity:p.processoStatus==="arquivado"?0.6:1,border:urgente?"1.5px solid #C62828":undefined,animation:urgente?"pulseUrgente 2s ease-in-out infinite":undefined}}>
                    <div style={{padding:"10px 14px",borderBottom:"1px solid #EEF1F4",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                      ...
                      <div style={{display:"flex",gap:4}}>
                        ...
                        <button onClick={()=>{setEditMU(p);setModalMU(true);}} title="Editar" style={{background:"#1565C0",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"3px 7px",fontSize:10,fontWeight:600}}>✏️</button>
                        <button onClick={()=>updateMU(p.id,{processoStatus:p.processoStatus==="arquivado"?"em_andamento":"arquivado"})} title={p.processoStatus==="arquivado"?"Reabrir":"Arquivar"} style={{background:"#64748B",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"3px 7px",fontSize:10}}>{p.processoStatus==="arquivado"?"📤":"🗄️"}</button>
        ...
        {tab==="execucao_mau_uso"&&(()=>{
          ...
          const qtdAguardCliente=lista.filter(x=>x.status==="aguardando_disponibilidade_cliente").length;
                ...
                <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.45)",zIndex:300,display:"flex",alignItems:"center",justifyContent:"center",padding:16}} onClick={e=>{if(e.target===e.currentTarget){setModalExecMU(false);setEditExecMU(null);setExecMUForm(EXECMU_EMPTY);}}}>
                  <div style={{background:"#FFF",borderRadius:14,width:"100%",maxWidth:640,maxHeight:"90vh",overflowY:"auto",boxShadow:"0 20px 60px rgba(0,0,0,.25)"}}>
                    ...
                    <div style={{padding:18,display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
                      ...
                      <div style={{display:"flex",flexDirection:"column",gap:3,gridColumn:"span 2"}}><label style={{fontSize:10,fontWeight:700,color:"#999",textTransform:"uppercase"}}>Observação</label><textarea value={execMUForm.observacao||""} onChange={e=>setExecMUForm(p=>({...p,observacao:e.target.value}))} placeholder="Observações..." rows={2} style={{fontSize:12,padding:"7px 8px",borderRadius:6,border:"1px solid #E0E0E0",resize:"vertical",fontFamily:"inherit"}}/></div>
        ...
        {tab==="dashboard"&&(
          <div style={{animation:"fadeIn .3s ease"}}>
            ...
            {(()=>{
              ...
              // Serviços realizados (agregado — sem cruzar com técnico, pra evitar granularidade excessiva)
              ...
              const sTQ=SVC.map(sv=>dashReports.filter(s=>s.servicos&&s.servicos.includes(sv)).length);
              ...
              const porPat={};
              dashReports.filter(a=>a.atendimento==="corretivo"&&a.patrimonio&&a.data).forEach(a=>{
              ...
              Object.entries(porPat).forEach(([pat,list])=>{
                ...
                for(let i=1;i<ordenado.length;i++){
                  ...
                  if(dias>=0&&dias<=30){
                    retrabalhos.push({pat,dataAnterior:ordenado[i-1].data,dataAtual:ordenado[i].data,dias,tecnico:ordenado[i].tecnico,tecnicoAnterior:ordenado[i-1].tecnico,cliente:ordenado[i].cliente});
                  }
                }
              });
        ...
        {tab==="uber"&&(()=>{
          ...
          const listaFil=lista.filter(applyFilter);
          const ST_SOLID_UBER={pendente:"#B45309",concluido:"#14532D",cancelado:"#7C2D2D"};
          return(<div style={{animation:"fadeIn .3s ease"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:20,flexWrap:"wrap",gap:12}}>
              <div><div style={{fontWeight:900,fontSize:24,color:"#1A1A1A"}}>🚗 Uber / Transporte</div><div style={{fontSize:12,color:"#94A3B8",marginTop:2}}>{lista.length} pedido(s) · <span style={{color:"#B45309",fontWeight:700}}>{pend} pendentes</span></div></div>
              <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
            ...
            <div className="card" style={{padding:"8px 10px",marginBottom:14,display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
              <div style={{position:"relative",flex:1,minWidth:180}}><span style={{position:"absolute",left:10,top:"50%",transform:"translateY(-50%)",color:"#AAA",fontSize:11}}>🔍</span><input type="text" value={uberSearch} onChange={e=>setUberSearch(e.target.value)} placeholder="Buscar solicitante, empresa, motivo..." style={{width:"100%",padding:"7px 10px 7px 30px",fontSize:12,boxSizing:"border-box"}}/></div>
              <div style={{display:"flex",alignItems:"center",gap:5}}><span style={{fontSize:11,color:"#888",fontWeight:600}}>De</span><input type="date" value={uberFrom} onChange={e=>setUberFrom(e.target.value)}/></div>
              <div style={{display:"flex",alignItems:"center",gap:5}}><span style={{fontSize:11,color:"#888",fontWeight:600}}>Até</span><input type="date" value={uberTo} onChange={e=>setUberTo(e.target.value)}/></div>
              <select value={uberMes} onChange={e=>setUberMes(e.target.value)}><option value="">Mês</option>{["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"].map((m,i)=><option key={i} value={String(i+1).padStart(2,"0")}>{m}</option>)}</select>
              <select value={uberAno} onChange={e=>setUberAno(e.target.value)}><option value="">Ano</option>{[2024,2025,2026,2027].map(y=><option key={y}>{y}</option>)}</select>
              {(uberSearch||uberFrom||uberTo||uberMes||uberAno)&&<button onClick={()=>{setUberSearch('');setUberFrom('');setUberTo('');setUberMes('');setUberAno('');}} style={{padding:"6px 12px",borderRadius:20,background:"#1A1A1A",color:"#FFF",border:"none",fontSize:11,cursor:"pointer",fontWeight:600}}>✕ Limpar</button>}
            </div>
            {listaFil.length===0?(<div className="card" style={{padding:64,textAlign:"center",color:"#CCC"}}><div style={{fontSize:40,marginBottom:12}}>🚗</div><div style={{fontSize:12,fontWeight:600}}>Nenhum pedido</div></div>):(
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(340px,1fr))",gap:14}}>
                {listaFil.map(p=>{
                  const stSolid=ST_SOLID_UBER[p.status||"pendente"]||ST_SOLID_UBER.pendente;
                  return(<div key={p.id} className="card" style={{padding:0,overflow:"hidden",opacity:p.arquivado?0.55:1}}>
                    <div style={{padding:"10px 14px",borderBottom:"1px solid #EEF1F4",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                      <select value={p.status||"pendente"} onChange={e=>updateUber(p.id,{status:e.target.value})} style={{fontSize:10,fontWeight:700,padding:"3px 10px",borderRadius:20,border:"none",color:"#FFF",background:stSolid,cursor:"pointer"}}>
                      ...
                      <div style={{display:"flex",gap:6}}>
                        <button onClick={()=>{setUberEdit(p);setUberModal(true);}} title="Editar" style={{background:"#1565C0",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"5px 9px",fontSize:11}}>✏️</button>
                        <button onClick={()=>updateUber(p.id,{arquivado:!p.arquivado})} title={p.arquivado?"Desarquivar":"Arquivar"} style={{background:"#64748B",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"5px 9px",fontSize:11}}>{p.arquivado?"📤":"🗄️"}</button>
                        <button onClick={()=>{if(window.confirm("Excluir?"))delUber(p.id);}} title="Excluir" style={{background:"#DC2626",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"5px 9px",fontSize:11,fontWeight:700}}>✕</button>
                      </div>
                    </div>
                    <div style={{padding:"12px 14px",display:"flex",flexDirection:"column",gap:10}}>
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
        ...
        {tab==="financeiro"&&(()=>{
          ...
          return(<div style={{animation:"fadeIn .3s ease"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:20,flexWrap:"wrap",gap:12}}>
              <div><div style={{fontWeight:900,fontSize:24,color:"#1A1A1A"}}>💳 Financeiro</div><div style={{fontSize:12,color:"#94A3B8",marginTop:2}}>{lista.length} lançamento(s) · <span style={{color:"#B45309",fontWeight:700}}>{pend} pendentes</span></div></div>
              <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:14,marginBottom:18}}>
              {[{l:"Total",v:lista.length,c:"#1A1A1A"},{l:"Pendentes",v:pend,c:"#B45309"},{l:"Pagos",v:pago,c:"#1A7A3C"},{l:"Sem Acerto",v:semAcerto,c:"#B45309"}].map((k,i)=>(
                <div key={i} className="card" style={{padding:"14px 16px",borderLeft:`4px solid ${k.c}`}}>
                  <div style={{fontSize:9,fontWeight:700,color:"#94A3B8",textTransform:"uppercase",letterSpacing:.8}}>{k.l}</div>
            ...
            {totalVal>0&&<div className="card" style={{padding:"14px 20px",marginBottom:18,borderLeft:"4px solid #1D4E89",display:"flex",alignItems:"center",gap:12}}>
              <div style={{fontSize:22}}>💵</div><div><div style={{fontSize:9,fontWeight:700,color:"#94A3B8",textTransform:"uppercase",letterSpacing:.8}}>Total em Lançamentos</div><div style={{fontSize:20,fontWeight:900,color:"#1D4E89"}}>R$ {totalVal.toLocaleString("pt-BR",{minimumFractionDigits:2})}</div></div>
            </div>}
            <div className="card" style={{padding:"8px 10px",marginBottom:14,display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
              <div style={{position:"relative",flex:1,minWidth:200}}><span style={{position:"absolute",left:10,top:"50%",transform:"translateY(-50%)",color:"#AAA",fontSize:11}}>🔍</span><input type="text" value={finSearch} onChange={e=>setFinSearch(e.target.value)} placeholder="Buscar técnico, ticket, atendimento, PAT..." style={{width:"100%",padding:"7px 10px 7px 30px",fontSize:12,boxSizing:"border-box"}}/></div>
              <div style={{display:"flex",alignItems:"center",gap:5}}><span style={{fontSize:11,color:"#888",fontWeight:600}}>De</span><input type="date" value={finFrom} onChange={e=>setFinFrom(e.target.value)}/></div>
              <div style={{display:"flex",alignItems:"center",gap:5}}><span style={{fontSize:11,color:"#888",fontWeight:600}}>Até</span><input type="date" value={finTo} onChange={e=>setFinTo(e.target.value)}/></div>
              <select value={finMes} onChange={e=>setFinMes(e.target.value)}><option value="">Mês</option>{["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"].map((m,i)=><option key={i} value={String(i+1).padStart(2,"0")}>{m}</option>)}</select>
              <select value={finAno} onChange={e=>setFinAno(e.target.value)}><option value="">Ano</option>{[2024,2025,2026,2027].map(y=><option key={y}>{y}</option>)}</select>
              {(finSearch||finFrom||finTo||finMes||finAno)&&<button onClick={()=>{setFinSearch('');setFinFrom('');setFinTo('');setFinMes('');setFinAno('');}} style={{padding:"6px 12px",borderRadius:20,background:"#1A1A1A",color:"#FFF",border:"none",fontSize:11,cursor:"pointer",fontWeight:600}}>✕ Limpar</button>}
            </div>
            {listaFil.length===0?(<div className="card" style={{padding:64,textAlign:"center",color:"#CCC"}}><div style={{fontSize:40,marginBottom:12}}>💳</div><div style={{fontSize:12,fontWeight:600}}>Nenhum lançamento</div></div>):(
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(340px,1fr))",gap:14}}>
                {listaFil.map(f=>{
                  const sol=SOL[f.solicitacao||"outros"]||SOL.outros;
                  const pago=f.situacao==="pago";
                  return(<div key={f.id} className="card" style={{padding:0,overflow:"hidden",opacity:f.arquivado?0.55:1}}>
                    <div style={{padding:"10px 14px",borderBottom:"1px solid #EEF1F4",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                      <div style={{display:"flex",gap:6,alignItems:"center"}}>
                        <span style={{fontSize:10,fontWeight:700,color:"#475569",background:"#F1F5F9",borderRadius:20,padding:"3px 11px"}}>{sol.l}</span>
                        <select value={f.situacao||"pendente"} onChange={e=>updateFin(f.id,{situacao:e.target.value})} style={{fontSize:10,fontWeight:700,padding:"3px 10px",borderRadius:20,border:"none",color:"#FFF",background:pago?"#14532D":"#7C2D2D",cursor:"pointer"}}><option value="pago">Pago</option><option value="pendente">Pendente</option></select>
                      </div>
                      <div style={{display:"flex",gap:6}}>
                        <button onClick={()=>{setFinEdit(f);setFinModalOpen(true);}} title="Editar" style={{background:"#1565C0",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"5px 9px",fontSize:11}}>✏️</button>
                        <button onClick={()=>updateFin(f.id,{arquivado:!f.arquivado})} title={f.arquivado?"Desarquivar":"Arquivar"} style={{background:"#64748B",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"5px 9px",fontSize:11}}>{f.arquivado?"📤":"🗄️"}</button>
                        <button onClick={()=>{if(window.confirm("Excluir?"))delFin(f.id);}} title="Excluir" style={{background:"#DC2626",border:"none",borderRadius:6,color:"#FFF",cursor:"pointer",padding:"5px 9px",fontSize:11,fontWeight:700}}>✕</button>
                      </div>
                    </div>
                    <div style={{padding:"12px 14px",display:"flex",flexDirection:"column",gap:10}}>
                      <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                        <div><div style={{fontSize:14,fontWeight:800,color:"#1A1A1A",marginBottom:2}}>{f.tecnico||"—"}</div><div style={{fontSize:11,color:"#94A3B8"}}>{f.data||"—"} · Ticket {f.ticket||"—"}</div></div>
                        <div style={{fontSize:16,fontWeight:900,color:"#14532D"}}>{f.valor?`R$ ${f.valor}`:"R$ —"}</div>
                      </div>
                      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",rowGap:8,columnGap:10,paddingTop:8,borderTop:"1px solid #F1F5F9"}}>
                        <div style={{gridColumn:"span 2"}}><div style={{color:"#94A3B8",fontSize:9,fontWeight:700,textTransform:"uppercase",marginBottom:2}}>Atendimento / PAT</div><input type="text" defaultValue={f.atendimento||""} onBlur={e=>updateFin(f.id,{atendimento:e.target.value})} placeholder="—" style={{width:"100%",fontSize:12,color:"#1A1A1A",border:"none",background:"transparent",outline:"none",padding:0}}/></div>
                        <div><div style={{color:"#94A3B8",fontSize:9,fontWeight:700,textTransform:"uppercase",marginBottom:2}}>Acerto</div><select value={f.acerto||"nao"} onChange={e=>updateFin(f.id,{acerto:e.target.value})} style={{fontSize:12,fontWeight:600,color:f.acerto==="sim"?"#1A7A3C":"#94A3B8"}}><option value="sim">Sim</option><option value="nao">Não</option></select></div>
                        <div><div style={{color:"#94A3B8",fontSize:9,fontWeight:700,textTransform:"uppercase",marginBottom:2}}>Ticket Acerto</div><input type="text" defaultValue={f.ticketAcerto||""} onBlur={e=>updateFin(f.id,{ticketAcerto:e.target.value})} placeholder="—" style={{width:"100%",fontSize:12,fontWeight:600,color:"#1A1A1A",border:"none",background:"transparent",outline:"none",padding:0}}/></div>
                        <div><div style={{color:"#94A3B8",fontSize:9,fontWeight:700,textTransform:"uppercase",marginBottom:2}}>Reembolso</div><select value={f.reembolso||"nao"} onChange={e=>updateFin(f.id,{reembolso:e.target.value})} style={{fontSize:12,fontWeight:600,color:f.reembolso==="sim"?"#6A1B9A":"#94A3B8"}}><option value="sim">Sim</option><option value="nao">Não</option></select></div>
                        {f.reembolso==="sim"&&<>
                          <div><div style={{color:"#94A3B8",fontSize:9,fontWeight:700,textTransform:"uppercase",marginBottom:2}}>Valor Reembolso</div><input type="text" defaultValue={f.valorReembolso||""} onBlur={e=>updateFin(f.id,{valorReembolso:e.target.value})} placeholder="R$ 0,00" style={{width:"100%",fontSize:12,fontWeight:700,color:"#6A1B9A",border:"none",background:"transparent",outline:"none",padding:0}}/></div>
                          <div><div style={{color:"#94A3B8",fontSize:9,fontWeight:700,textTransform:"uppercase",marginBottom:2}}>Data Reembolso</div><input type="date" defaultValue={f.dataReembolso||""} onBlur={e=>updateFin(f.id,{dataReembolso:e.target.value})} style={{width:"100%",fontSize:12,color:"#1A1A1A",border:"none",background:"transparent",outline:"none",padding:0}}/></div>
                          <div style={{gridColumn:"span 2"}}><div style={{color:"#94A3B8",fontSize:9,fontWeight:700,textTransform:"uppercase",marginBottom:2}}>Ticket Reembolso</div><input type="text" defaultValue={f.ticketReembolso||""} onBlur={e=>updateFin(f.id,{ticketReembolso:e.target.value})} placeholder="—" style={{width:"100%",fontSize:12,fontWeight:600,color:"#1A1A1A",border:"none",background:"transparent",outline:"none",padding:0}}/></div>
                        </>}
                      </div>
                      <div style={{fontSize:10,color:"#CBD5E1",textAlign:"right"}}>{f.registradoPor||""}</div>
                    </div>
                  </div>);
                })}
              </div>
        ...
        {tab==="ferias_colaboradores"&&(()=>{
          ...
          return(<div style={{animation:"fadeIn .3s ease"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:16,flexWrap:"wrap",gap:12}}>
              <div><div style={{fontWeight:900,fontSize:24,letterSpacing:-.5}}>🏖️ Férias de Colaboradores</div><div style={{fontSize:12,color:"#94A3B8",marginTop:2}}>{lista.length} colaborador(es) · <span style={{color:"#1565C0",fontWeight:700}}>{emFeriasN} em férias</span> · <span style={{color:"#E67E00",fontWeight:700}}>{proximasN} próximas (30d)</span></div></div>
              <div style={{display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
                    ...
                    <tbody>
                      {filtrada.map(f=>{
                        ...
                        return(<tr key={f.id} style={{background:cfg.bg,opacity:f.arquivado?0.5:1,borderLeft:`4px solid ${cfg.borda}`}}>
                          ...
                          <td style={{...td,whiteSpace:"nowrap"}}><div style={{display:"flex",alignItems:"center",gap:2}}><input type="date" defaultValue={f.aquisitivoIni||""} onBlur={e=>e.target.value!==(f.aquisitivoIni||"")&&updateFerias(f.id,{aquisitivoIni:e.target.value})} style={{...inp,width:120}}/><span style={{color:"#CBD5E1"}}>→</span><input type="date" defaultValue={f.aquisitivoFim||""} onBlur={e=>e.target.value!==(f.aquisitivoFim||"")&&updateFerias(f.id,{aquisitivoFim:e.target.value})} style={{...inp,width:120}}/></div></td>
                          <td style={td}><input type="date" defaultValue={f.limite||""} onBlur={e=>e.target.value!==(f.limite||"")&&updateFerias(f.id,{limite:e.target.value})} style={{...inp,width:120,color:venc(f)?"#C62828":"#1A1A1A",fontWeight:venc(f)?800:400}}/></td>
                          <td style={td}><input type="text" defaultValue={f.saldoDias||""} onBlur={e=>e.target.value!==(f.saldoDias||"")&&updateFerias(f.id,{saldoDias:e.target.value})} style={{...inp,width:44,textAlign:"center",fontWeight:700}}/></td>
      ...
      {/* ── DASHBOARD REQUISIÇÕES ── */}
        ...
        {tab==="planilha_comissao_sas"&&(()=>{
          ...
          return(<div style={{animation:"fadeIn .3s ease"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:20,flexWrap:"wrap",gap:12}}>
              <div><div style={{fontWeight:900,fontSize:24,color:"#1A1A1A"}}>🧮 Planilha de Comissão SAS</div><div style={{fontSize:12,color:"#94A3B8",marginTop:2}}>Preenche o modelo oficial do fabricante (estrutura e fórmulas originais preservadas) com os dados do SAS Financeiro</div></div>
        ...
        {tab==="sas_vendas"&&(()=>{
          ...
          const pend=lista.filter(s=>s.status==="aberta"||!s.status).length;
          const conc=lista.filter(s=>s.status==="concluida").length;
          const findCategoria=modelo=>{const e=Object.entries(SAS_VENDAS_MODELOS).find(([,ms])=>ms.includes(modelo));return e?e[0]:"";};
          const applyFilter=(r,d=r.prazoEntregaInicial||"")=>{
            if(sasVendSearch){const q=sasVendSearch.toLowerCase();if(!((r.cliente||"").toLowerCase().includes(q)||(r.cnpj||"").toLowerCase().includes(q)||(r.modeloSAS||"").toLowerCase().includes(q)||(r.numero||"").toLowerCase().includes(q)))return false;}
          ...
          return(<div style={{animation:"fadeIn .3s ease"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:14,marginBottom:18}}>
              {[{l:"Total",v:lista.length,c:"#1A1A1A"},{l:"Abertas",v:pend,c:"#B45309"},{l:"Concluídas",v:conc,c:"#1A7A3C"}].map((k,i)=>(
                <div key={i} className="card" style={{padding:"14px 16px",borderLeft:`4px solid ${k.c}`}}>
                  <div style={{fontSize:9,fontWeight:700,color:"#94A3B8",textTransform:"uppercase",letterSpacing:.8}}>{k.l}</div>
                  <div style={{fontSize:22,fontWeight:900,color:k.c,marginTop:2}}>{k.v}</div>
                </div>
            ...
            {showFiltrosSasVend&&<div className="card" style={{padding:"8px 10px",marginBottom:14,display:"flex",gap:8,flexWrap:"wrap",alignItems:"center"}}>
              <div style={{position:"relative",flex:1,minWidth:180}}><span style={{position:"absolute",left:10,top:"50%",transform:"translateY(-50%)",color:"#AAA",fontSize:11}}>🔍</span><input type="text" value={sasVendSearch} onChange={e=>setSasVendSearch(e.target.value)} placeholder="Buscar cliente, CNPJ, modelo, nº proposta..." style={{width:"100%",padding:"7px 10px 7px 30px",fontSize:12,boxSizing:"border-box"}}/></div>
            ...
            {listaFil.length===0?(<div className="card" style={{padding:64,textAlign:"center",color:"#CCC"}}><div style={{fontSize:40,marginBottom:12}}>💰</div><div style={{fontSize:12,fontWeight:600}}>Nenhuma proposta</div></div>):(
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))",gap:12}}>
                {listaFil.map(s=>{
                  const ok=s.status==="concluida";
                  const stSolid=ok?"#14532D":"#1D4E89";
                  return(<div key={s.id} className="card" style={{padding:0,overflow:"hidden",opacity:s.status==="arquivado"?0.55:1}}>
                    <div style={{padding:"8px 10px",borderBottom:"1px solid #EEF1F4",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                      <span style={{fontSize:11,fontWeight:800,color:"#1A1A1A"}}>{s.numero||"—"}</span>
                      <div style={{display:"flex",gap:4}}>
                        <button onClick={()=>gerarPDFPropostaSasVend(s,s.registradoPor||user.name)} title="Gerar PDF" style={{background:"#F5C200",border:"none",borderRadius:5,color:"#1A1A1A",cursor:"pointer",padding:"3px 6px",fontSize:10}}>📄</button>
                        <button onClick={()=>{setSasVendEdit(s);setSasVendModal(true);}} title="Editar" style={{background:"#1565C0",border:"none",borderRadius:5,color:"#FFF",cursor:"pointer",padding:"3px 6px",fontSize:10}}>✏️</button>
                        <button onClick={()=>updateSasVend(s.id,{status:s.status==="arquivado"?"aberta":"arquivado"})} title={s.status==="arquivado"?"Reabrir":"Arquivar"} style={{background:"#64748B",border:"none",borderRadius:5,color:"#FFF",cursor:"pointer",padding:"3px 6px",fontSize:10}}>{s.status==="arquivado"?"📤":"🗄️"}</button>
                        <button onClick={()=>{if(window.confirm("Excluir?"))delSasVend(s.id);}} title="Excluir" style={{background:"#DC2626",border:"none",borderRadius:5,color:"#FFF",cursor:"pointer",padding:"3px 6px",fontSize:10,fontWeight:700}}>✕</button>
                      </div>
                    </div>
