                ...
                <div style={{marginTop:16}}>
                  ...
                  <div className="card" style={{padding:0,overflow:"hidden"}}>
                    ...
                    {muSemana.length===0?(<div style={{padding:20,textAlign:"center",color:"#CBD5E1",fontSize:11}}>Nenhum registro no período</div>):(
                      <div className="tbl-wrap"><table style={{minWidth:1120}}>
                        <thead><tr><th style={{minWidth:190}}>Empresa</th><th style={{minWidth:90}}>Nº Mau Uso</th><th style={{minWidth:110}}>Data Envio</th><th style={{minWidth:120}}>Data Aprovação</th><th style={{minWidth:120}}>Valor</th><th style={{minWidth:90}}>Nota Débito</th><th style={{minWidth:90}}>Ticket Fatur.</th><th style={{minWidth:120}}>Dt Envio Ticket</th><th style={{minWidth:180}}>Status Aprovação</th></tr></thead>
